...
namespace Aec.Cqrs.WebUI.Infrastructure
{
    ...
    {
        private readonly IDocumentReader<UserID, LoginView> m_view;
        private static readonly IPrincipal s_anonymous = new GenericPrincipal(new GenericIdentity(""), new string[0]);
        ...
        public void InitializeRequest()
        {
            ...
            GetOrLoadRealPrincipal(username)
                ...
                .Handle(() => context.User = s_anonymous);
        }
        ...
        {
            var maybe = m_view.Get(info.Login);
            if (!maybe.HasValue)
